...
Version 1.0.3 | [GitHub](https://github.com/modpotato-plugins/artificial-enchantments)
...
**Never shade this library.** Install `artificial-enchantments-1.0.3.jar` once in `plugins/`. All dependent plugins use `compileOnly`.
